...
### Requirement: E2E spec name
FROM: References to "chapter init", "chapter validate", "chapter list", "chapter install", "chapter disable", "chapter enable"
TO: "mason init", "mason validate", "mason list", "mason install", "mason disable", "mason enable"

### Requirement: E2E setup/teardown scripts
FROM: `setup-chapter.ts`, `teardown-chapter.ts`
TO: `setup.ts`, `teardown.ts`
