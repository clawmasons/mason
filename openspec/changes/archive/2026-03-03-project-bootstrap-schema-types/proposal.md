...
### New Capabilities
- `package-schema-validation`: Zod-based schema validators for the `pam` field in package.json across all five package types (app, skill, task, role, agent). Includes TypeScript type exports, discriminated union parsing, and clear error messages for invalid metadata.
...
- Establishes the `@clawforge/pam` package name and initial exports
