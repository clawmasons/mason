...
- Expose validation as both a programmatic API and a CLI command (`forge validate <agent>`)
...
- Permission matrix display (`forge permissions` — separate command)
- Lock file generation (`forge build` — separate command)
