...
- Generate proxy authentication tokens (`PAM_PROXY_TOKEN`) for bearer-token auth
...
- **No CLI changes:** This change provides the programmatic API. CLI integration (`pam permissions`, `pam install`) will use these functions in subsequent changes.
