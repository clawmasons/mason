...
Defines the non-interactive print mode for `mason run`, enabling scripted/pipeline usage where the agent runs with a prompt and outputs only the final result text to stdout.
