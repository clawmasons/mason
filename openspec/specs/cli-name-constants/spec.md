# cli-name-constants Specification

## Purpose

Shared CLI name constants exported from `@clawmasons/shared` to serve as the single source of truth for the product name across all packages.
