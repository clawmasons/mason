...
Defines the structure, naming, and content of the `@clawforge/forge-core` component library package — the standard set of reusable apps, tasks, skills, roles, and agents that ship with forge.
