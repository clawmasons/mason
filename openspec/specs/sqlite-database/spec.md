...
## Purpose
Provide a shared SQLite database layer for the proxy, supporting audit logging of all tool calls and approval request workflows. The module handles connection management, schema creation, and typed CRUD operations.
