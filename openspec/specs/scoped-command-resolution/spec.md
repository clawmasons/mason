...
Provides single-task resolution by scope and name, enabling targeted file reads instead of bulk directory scans. Used as the primary mechanism for resolving task content from ROLE.md references.
