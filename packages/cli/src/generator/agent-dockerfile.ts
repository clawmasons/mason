...
`;
  ...
  const workspaceCopyLine = isSupervisor
    ? ""
    : `COPY --chown=mason:mason ${roleShortName}/${primaryRuntime}/build/workspace/ /home/mason/workspace/`;
...
COPY --chown=mason:mason ${roleShortName}/${primaryRuntime}/home/ /home/mason/
`
    : "";
...
WORKDIR /home/mason
${runtimeInstall}${aptInstallStep}${npmInstallStep}
...
RUN (getent group $HOST_GID | cut -d: -f1 | xargs -r groupdel 2>/dev/null || true) \\
    ...
    && chown -R mason:mason /home/mason /logs

# Copy agent-entry bundle (self-contained node script) into PATH
COPY agent-entry.js /usr/local/bin/agent-entry
